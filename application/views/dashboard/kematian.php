...
<body>
                ...
                <div class="menu-wrapper py-1">
                    <aside class="menu">
                        ...
                        <ul class="menu-list">
                            ...
                            <li><a class="is-active has-background-info">Data Kematian</a></li>
                        </ul>
                    </aside>
                </div>
            </div>
            ...
            <div class="p-1">
                ...
                <div class="columns is-variable is-dekstop">
                    <div class="column">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="button is-warning modal-button" data-target="#modalEdit"
                                                data-kk="<?= $kematian['no_kematian'] . '-' . $kematian['penyebab'] ?>">
                        ...
                        <a class="button is-info is-focused modal-button" data-target="#modalAdd">Tambah Data Kematian</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-background"></div>
        <div class="modal-card">
            <header class="modal-card-head">
                <p class="modal-card-title">Tambah Data Kematian</p>
                <button class="delete button-close" aria-label="close"></button>
            </header>
            <section class="modal-card-body">
                <form action="http://localhost:8888/sensus/index.php/kematian/doaddkematian" method="POST">
                    <div class="field">
                    ...
                    <div class="field">
                        <label for="#tglkematian" class="label">Tanggal Kematian</label>
                        <div class="control">
                            <input type="date" class="input" data-date-format="YYYY-MM-DD" data-display-mode="inline" id="tglkematian" name="tglkematian" placeholder="e.g Jakarta">
                        </div>
                    </div>
                    <div class="field">
                        <label for="#penyebab" class="label">Penyebab</label>
                        <div class="control">
                            <input type="text" class="input" id="penyebab" name="penyebab" placeholder="e.g Sakit">
                        </div>
                    </div>
            </section>
    ...
    <div class="modal-background"></div>
        <div class="modal-card">
            ...
            <section class="modal-card-body">
                <form action="http://localhost:8888/sensus/index.php/kematian/doeditkematian" method="POST">
                    <div class="field">
                        <label for="" class="label">No Kematian</label>
                        <div class="control">
                            <input type="text" class="input" id="input" name="nokematian" placeholder="">
                        </div>
                    </div>
                    <div class="field">
                        <label for="#nik" class="label">NIK</label>
                    ...
                    <div class="field">
                        <label for="#penyebab" class="label">Penyebab</label>
                        <div class="control">
                            <input type="text" class="input" id="input" name="penyebab" placeholder="e.g Sakit">
                        </div>
                    </div>
            </section>
            <footer class="modal-card-foot">
